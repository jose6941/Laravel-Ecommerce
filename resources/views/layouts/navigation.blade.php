    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-gray-900 mr-4">{{ __('Entrar') }}</a>
                    <a href="{{ route('register') }}" class="text-sm text-gray-600 hover:text-gray-900">{{ __('Cadastrar') }}</a>
                @endauth
            </div>
